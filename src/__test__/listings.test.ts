...
describe('PUT listing', () => {
  ...
  it("Should return 400 if user is authenticated but is trying to update a listing that doesn't exist", async () => {
    const email = generateRandomEmail();
  ...
  it("Should return 403 if user is authenticated but is trying to update a listing that they don't own", async () => {
    const email1 = generateRandomEmail();
    const email2 = generateRandomEmail();
  ...
  it('Should return 200 if user is authenticated and is correctly updating a listing of theirs', async () => {
    const email = generateRandomEmail();
